...
class UpdateEmployeesCommand extends Command
{
    ...
    {
        try {
            $employees = UpdateEmployeesCommand::updateEmployees();
        } catch (Exception $e) {
    ...
    public function updateEmployees()
    {
        ...
        try {
            $employees = UpdateEmployeesCommand::detailsEmployees();
        } catch (Exception $e) {
            $this->error("An error occurred");
        }
    }
    ...
    public function detailsEmployees()
    {
        ...
        $employees = DB::table("employees")->select('employeeNumber', 'ou')->get();
